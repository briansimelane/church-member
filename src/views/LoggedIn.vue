    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                ...
                <p class="mt-2 text-sm text-gray-700">Please contact the developer if you required different access <a
                        class="text-red-700">brian@learningsims.co.za</a></p>
            </div>
        ...
        <div
            class="-mx-4 mt-8 overflow-hidden shadow ring-1 ring-black ring-opacity-5 sm:-mx-6 md:mx-0 md:rounded-lg mb-5">
            ...
            <table class="min-w-full divide-y divide-gray-300">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th scope="col" class="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">
                            Name</th>
                        <th scope="col"
                            class="hidden px-3 py-3.5 text-left text-sm font-semibold text-gray-900 lg:table-cell">Class
                            number</th>
                        ...
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Date of birth
                        </th>
                        <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Education
                            level
                        </th>
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <tr v-for="(member, index) in members" :key="member.id">
                        <td
                            class="w-full max-w-0 py-1 text-sm font-medium text-gray-900 sm:w-auto sm:max-w-none sm:pl-6">
                            {{ index + 1 }}</td>
                        <td
                        ...
                        <td class="px-3 py-4 text-sm text-gray-500">{{ member.gender }}</td>
                        <td class="px-3 py-4 text-sm text-gray-500">{{ member.birthDate }}</td>
                        <td class="px-3 py-4 text-sm text-gray-500">{{ member.formalEducation_highestLevel }}</td>
